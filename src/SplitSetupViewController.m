...
@interface SplitSetupViewController()
{
    ...
    Game *game;
    id<SplitSetupViewControllerDelegate> __unsafe_unretained delegate;
}
...
@implementation SplitSetupViewController
...
- (void) loadView
{
    ...
    titlePrompt.text = @"game setup";
    titlePrompt.textAlignment = NSTextAlignmentCenter;
    [self.view addSubview:titlePrompt];
    
    CGFloat layoutViewx = (viewpadding);
    CGFloat layoutViewy = (titlePrompty+titlePrompth+viewpadding);
